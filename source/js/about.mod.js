...
//		console.debug('me.init',opt);
	...
	//	+				'the ReqIF Apps to these projects ... and we hope that our software will be useful to many people, as well.'
		...
		+		'</tr>'
		+		'<tr>'
		+			'<td><strong>BPMN-Viewer</strong></td>'
		+			'<td></td>'
		...
		+		'</tr>'
		+		'<tr>'
		+			'<td><strong>vis.js Network</strong></td>'
		+			'<td></td>'
	...
	/*	+		'<tr>'
		...
		+		'</tr>'
		+		'<tr>'
		+			'<td><strong>diff-match-patch</strong></td>'
		+			'<td></td>'
