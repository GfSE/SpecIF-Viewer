...
i18n.oslc_rm_validatedBy = "est valid&eacute; de";
...
i18n.SpecIF_Glossary = "&Eacute;lements de mod&egrave;le (Glossaire)";
...
i18n.IREB_refinedBy = "est affin&eacute; de";
...
i18n.SpecIF_sameAs =
i18n.owl_sameAs = "est identique &agrave;";
...
i18n.MsgImportReqif = "Types de fichiers valides: *.reqifz, *.reqif, *.zip et *.xml. Le contenu doit correspondre au sch&eacute;ma ReqIF 1.0+, RIF 1.1a ou RIF 1.2. Le t&eacute;l&eacute;chargement peut durer quelques minutes dans le cas de tr&egrave;s gros fichiers.";
...
i18n.MsgImportXls = "Types de fichiers valides: *.xls, *.xlsx et *.csv. Le t&eacute;l&eacute;chargement peut durer quelques minutes dans le cas de tr&egrave;s gros fichiers.";
i18n.MsgExport = "Un fichier zip-comprim&eacute; au format choisi sera cr&eacute;&eacute;. Le t&eacute;l&eacute;chargement peut durer quelques minutes dans le cas de tr&egrave;s gros projets; le navigateur va enregistrer le fichier comme configur&eacute;.";
