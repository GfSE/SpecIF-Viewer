...
//	self.LblRoleReqif = 'REQIF';
	...
	self.LblProjectUsers = '<span class="glyphicon glyphicon-user"/>&#160;Nutzer dieses Projekts';
	self.LblOtherUsers = 'Andere Nutzer';
	self.LblUserProjects = '<span class="glyphicon glyphicon-book"/>&#160;Projekte dieses Nutzers';
...
//	self.LblRifType = 'Typ';
	...
	self.LblStringMatch = '<span class="glyphicon glyphicon-text-background" />&#160;Textsuche';
	...
	self.BtnLogin = '<span class="glyphicon glyphicon-log-in"/>&#160;Anmelden';
	self.BtnLogout = '<span class="glyphicon glyphicon-log-out"/>&#160;Abmelden';
	self.BtnProfile = 'Profil';
	self.BtnBack = 'Zurück';
	self.BtnCancel = 'Abbrechen';
	self.BtnCancelImport = 'Abbrechen';
	self.BtnApply = 'Anwenden';
	self.BtnDelete = '<span class="glyphicon glyphicon-remove"/>&#160;Löschen';
	self.BtnDeleteObject = '<span class="glyphicon glyphicon-remove"/>&#160;Ressource mit Referenzen löschen';
	self.BtnDeleteObjectRef = '<span class="glyphicon glyphicon-remove"/>&#160;Diesen Verweis löschen';
	self.BtnImport = '<span class="glyphicon glyphicon-import"/>&#160;Import';
	self.BtnCreate = '<span class="glyphicon glyphicon-import"/>&#160;Anlegen';
	self.BtnReplace = '<span class="glyphicon glyphicon-import"/>&#160;Ersetzen';
	self.BtnAdopt = '<span class="glyphicon glyphicon-import"/>&#160;Adoptieren'; //Aneignen
...
//	self.BtnProjectFromTemplate = "Projekt mit ReqIF-Vorlage anlegen";
	self.BtnRead = '<span class="glyphicon glyphicon-eye-open"/>&#160;Lesen';
...
//	self.BtnExportReqif = '<span class="glyphicon glyphicon-export"/>&#160;ReqIF';
	self.BtnAdd = '<span class="glyphicon glyphicon-plus"/>&#160;Neu';
	self.BtnAddUser = '<span class="glyphicon glyphicon-plus"/>&#160;Nutzer';
	self.BtnAddProject = '<span class="glyphicon glyphicon-plus"/>&#160;'+	self.LblProject;
	self.BtnAddSpec = '<span class="glyphicon glyphicon-plus"/>&#160;Gliederung';
	self.BtnAddFolder = '<span class="glyphicon glyphicon-plus"/>&#160;Ordner';
	self.BtnAddAttribute = '<span class="glyphicon glyphicon-plus"/>&#160;Attribut';
	self.BtnAddTypeComment = '<span class="glyphicon glyphicon-plus"/>&#160;Klassen für Kommentare';
	self.BtnClone = '<span class="glyphicon glyphicon-duplicate"/>&#160;Klonen';
	self.BtnEdit = '<span class="glyphicon glyphicon-pencil"/>&#160;Bearbeiten';
	self.BtnSave = '<span class="glyphicon glyphicon-save"/>&#160;Speichern';
	self.BtnSaveRole = '<span class="glyphicon glyphicon-save"/>&#160;Rolle anlegen';
	self.BtnSaveAttr = '<span class="glyphicon glyphicon-save"/>&#160;Attribut anlegen';
	self.BtnInsert = '<span class="glyphicon glyphicon-save"/>&#160;Einfügen';
	self.BtnInsertSuccessor = '<span class="glyphicon glyphicon-save"/>&#160;Einfügen hinter';
	self.BtnInsertChild = '<span class="glyphicon glyphicon-save"/>&#160;Einfügen unter';
	self.BtnSaveRelation = '<span class="glyphicon glyphicon-save"/>&#160;Aussage anlegen';
	self.BtnSaveItem = '<span class="glyphicon glyphicon-save"/>&#160;~A anlegen';
	self.BtnDetails = 'Details';
	self.BtnAddRole = '<span class="glyphicon glyphicon-plus" />&#160;Rolle';
	self.BtnFileSelect = '<span class="glyphicon glyphicon-plus" />&#160;Datei auswählen ...';
...
// Tabs:
	...
	self.TabUserList = '<span class="glyphicon glyphicon-list"/>&#160;Nutzer';
	self.TabProjectList = '<span class="glyphicon glyphicon-list"/>&#160;Projekte';
//	self.TabProjectDetails = '<span class="glyphicon glyphicon-pencil"/>&#160;Meta';
	self.TabUserDetails = '<span class="glyphicon glyphicon-pencil"/>&#160;Meta';
	self.TabProjectUsers = '<span class="glyphicon glyphicon-user"/>&#160;Nutzer';
	self.TabUserProjects = '<span class="glyphicon glyphicon-book"/>&#160;Projekte';
	self.TabPermissions = '<span class="glyphicon glyphicon-lock"/>&#160;Rechte';
...
//	self.TabRifTypes = '<span class="glyphicon glyphicon-cog"/>&#160;'+	self.LblRifTypes;
	self.TabTable = '<span class="glyphicon glyphicon-th"/>&#160;Tabelle';
	self.TabDocument = '<span class="glyphicon glyphicon-book"/>&#160;Dokument';
	self.TabFind = '<span class="glyphicon glyphicon-search"/>&#160;Suche';
	self.TabFilter = 	self.IcoFilter+'&#160;Filter';
	self.TabPage = '<span class="glyphicon glyphicon-file"/>&#160;Seite';
	self.TabRevisions = '<span class="glyphicon glyphicon-grain"/>&#160;Revisionen';
	self.TabTimeline = '<span class="glyphicon glyphicon-film"/>&#160;Zeitleiste';
	self.TabRelations = '<span class="glyphicon glyphicon-link"/>&#160;Aussagen';
	self.TabSort = '<span class="glyphicon glyphicon-magnet"/>&#160;Sortieren';
	self.TabAttachments = '<span class="glyphicon glyphicon-paperclip"/>&#160;Bilder und Dateien';
	self.TabComments = '<span class="glyphicon glyphicon-comment"/>&#160;Kommentare';
	self.TabReports = '<span class="glyphicon glyphicon-stats"/>&#160;Berichte';

// Functions:
	self.FnProjectCreate = '<span class="glyphicon glyphicon-plus"/>&#160;Projekt';
	self.FnProjectImport = '<span class="glyphicon glyphicon-import"/>&#160;Projekt importieren';
//	self.FnImportReqif = '<span class="glyphicon glyphicon-import"/>&#160;ReqIF importieren';
//	self.FnImportCsv = '<span class="glyphicon glyphicon-import"/>&#160;CSV importieren';
//	self.FnImportXls = '<span class="glyphicon glyphicon-import"/>&#160;XLS importieren';
//	self.FnProjectFromTemplate = '<span class="glyphicon glyphicon-plus"/>&#160;Neues Projekt von Vorlage erstellen';
	self.FnRefresh = '<span class="glyphicon glyphicon-refresh"/>&#160;Aktualisieren';
...
//	self.SpecIF_Names = "Namen";
	...
	self.IREB_RequirementTypeFunction = "Funktion";
	self.IREB_RequirementTypeQuality = "Qualität";
	self.IREB_RequirementTypeConstraint = "Randbedingung";
