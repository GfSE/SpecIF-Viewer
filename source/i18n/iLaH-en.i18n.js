...
i18n.LblObjectTypes = 'Resource-types';
i18n.objectType = 
i18n.LblObjectType = 'Resource-type';
i18n.LblRelationTypes = 'Statement-types';
i18n.relationType = 
...
i18n.BtnUpdate = '<span class="glyphicon glyphicon-import"/>&nbsp;Update';
...
i18n.oslc_rm_satisfies = "satisfies";
...
i18n.SpecIF_Requirements = "Requirements";
...
i18n.SpecIF_Outline = "Outline";  
i18n.SpecIF_Outlines = "Outlines";
...
i18n.SpecIF_satisfies = "satisfies";
...
i18n.SpecIF_refines = "refines";
i18n.SpecIF_duplicates = "duplicates";
i18n.SpecIF_contradicts = "contradicts";
i18n.SpecIF_isAssociatedWith = "is associated with";
...
i18n.MsgImportReqif = 'Permissible filetypes are *.reqifz, *.reqif, *.zip and *.xml. The content must conform with the ReqIF 1.0+, RIF 1.1a or RIF 1.2 schemata. The import may take a couple of minutes up until an hour for very large files.';
i18n.MsgImportSpecif = 'Permissible filetypes are *.specifz and *.specif. The content must conform with the SpecIF 0.8+ schemata. The import may take a couple of minutes up until an hour for very large files.';
...
i18n.MsgImportXls = 'Permissible filetypes are *.xls, *.xlsx and *.csv. The import may take a couple of minutes up until an hour for very large files.';
i18n.MsgExport = 'A zip-compressed file of the chosen format will be created. The export may take a couple of minutes up until an hour for very large files; your browser will save the file according to its settings.';
