...
//		console.debug('me.init',opts);
	...
	self.show = function( opts?:any ):void {
		...
		+	'</ul>'
		+	'<p>The <a href="https://specif.de" target="_blank" rel="noopener">SpecIF Homepage</a> provides further information.</p>'
		+	'<p>The software code published on <a href="https://github.com/GfSE/SpecIF-Viewer" target="_blank" rel="noopener">github.com</a>'
		+		' is a reference implementation and has not been designed for high data volume and other production requirements.' 
		+		' The installation provided for your convenience at <a href="https://specif.de/apps/'+(isEditor? 'edit':'view')+'" target="_blank" rel="noopener">https://specif.de/apps/'+(isEditor? 'edit':'view')+'</a>'
		+		' is neither intended to be highly available nor scalable.'
		+		' You may use the <a href="https://github.com/GfSE/SpecIF-Viewer/releases" target="_blank" rel="noopener">latest release</a> of the software for your own installation.'
		...
		+	'<p>License: <a href="https://github.com/GfSE/SpecIF-Viewer/blob/master/LICENSE" target="_blank" rel="noopener">Apache 2.0</a></p>'
		+	'<h4>Features</h4>'
		+		'<ul>'
	...
	// So far, editing is needed in case of Achimate for manually adding the diagrams ..
		...
		+		' we appreciate if you open an <a href="https://github.com/GfSE/SpecIF-Viewer/issues" target="_blank" rel="noopener">issue</a>'
	...
	/*	+		' Our policy is to donate 12% of our revenues made with'
		...
		+		'<tr>'
		+			'<td>AJV</td>'
		+			'<td><a href="https://github.com/epoberezkin" target="_blank" rel="noopener">Evgeny Poberezkin</a></td>'
		+			'<td>Another JSON Schema Validator ... <a href="https://github.com/epoberezkin/ajv" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://github.com/epoberezkin/ajv/blob/master/LICENSE" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>jqTree</td>'
		...
		+			'<td><a href="https://github.com/mbraak/jqTree/blob/master/LICENSE" target="_blank" rel="noopener">Apache 2.0</a></td>'
		+		'</tr>'
		+ (moduleManager.isReady('markdown')?
	/*			'<tr>'
			+		'<td>remarkable</td>'
			+		'<td><a href="https://github.com/jonschlinkert" target="_blank" rel="noopener">Jon Schlinkert</a></td>'
			+		'<td>Markdown parser, done right. Commonmark support, extensions, syntax plugins, high speed ... <a href="https://github.com/jonschlinkert/remarkable" target="_blank" rel="noopener">more</a></td>'
			+		'<td><a href="https://github.com/jonschlinkert/remarkable/blob/master/LICENSE" target="_blank" rel="noopener">MIT</a></td>'
			+	'</tr>' */
				'<tr>'
			+		'<td>markdown-it</td>'
			+		'<td><a href="https://github.com/Kirill89" target="_blank">Kirill</a>,&nbsp;<a href="https://github.com/puzrin" target="_blank" rel="noopener">Vitaly Puzrin</a>,&nbsp;<a href="https://github.com/rlidwka" target="_blank" rel="noopener">Alex Kocharin</a></td>'
			+		'<td>Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed ... <a href="https://markdown-it.github.io/" target="_blank" rel="noopener">more</a></td>'
			+		'<td><a href="https://github.com/jonschlinkert/remarkable/blob/master/LICENSE" target="_blank" rel="noopener">MIT</a></td>'
			+	'</tr>' 
			:   '')
		+		'<tr>'
		+			'<td>JSZip</td>'
		+			'<td><a href="https://github.com/Stuk" target="_blank" rel="noopener">Stuart Knightley, David Duponchel, Franz Buchinger, António Afonso</a></td>'
		+			'<td>A library for creating, reading and editing .zip files ... <a href="https://github.com/Stuk/jszip" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://github.com/Stuk/jszip/blob/master/LICENSE.markdown" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>FileSaver</td>'
		+			'<td><a href="http://eligrey.com/" target="_blank" rel="noopener">Eli Grey</a></td>'
		+			'<td>Save files to the local file system ... <a href="https://github.com/eligrey/FileSaver.js/" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://github.com/eligrey/FileSaver.js/blob/master/LICENSE.md" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>BPMN-Viewer</td>'
		+			'<td></td>'
		+			'<td>A BPMN 2.0 rendering toolkit and web modeler ... <a href="https://bpmn.io/toolkit/bpmn-js/" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://github.com/bpmn-io/bpmn-js/blob/develop/LICENSE" target="_blank" rel="noopener">bpmn.io</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>vis.js Network</td>'
		+			'<td></td>'
		+			'<td>Display networks consisting of nodes and edges ... '
		+				'<a href="https://visjs.github.io/vis-network/docs/network/" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="http://www.apache.org/licenses/LICENSE-2.0" target="_blank" rel="noopener">Apache 2.0</a> or '
		+				'<a href="http://opensource.org/licenses/MIT" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>js-xlsx</td>'
		+			'<td></td>'
		+			'<td>Excel parser and writer ... <a href="https://github.com/SheetJS/js-xlsx" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://github.com/SheetJS/js-xlsx/blob/master/LICENSE" target="_blank" rel="noopener">Apache 2.0</a></td>'
		+		'</tr>'
	/*	+		'<tr>'
		+			'<td>DataTables</td>'
		+			'<td></td>'
		+			'<td>DataTables is a highly flexible tool adding advanced interaction controls to any HTML table ... '
		+				'<a href="http://www.datatables.net" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="http://www.datatables.net/license/mit" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'  */
		+		'<tr>'
		+			'<td>Font Awesome</td>'
		+			'<td></td>'
		+			'<td>Font Awesome gives you scalable vector icons that can instantly be customized — size, color, drop shadow, '
		+				'and anything that can be done with the power of CSS ... <a href="https://fontawesome.com/v4.7/" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://fontawesome.com/v4.7/license/" target="_blank" rel="noopener">SIL OFL 1.1</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>jQuery</td>'
		+			'<td></td>'
		+			'<td>jQuery makes things like HTML document traversal and manipulation, event handling, animation, and Ajax '
		+				'much simpler ... <a href="https://jquery.com/" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://jquery.org/license/" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'
		+		'<tr>'
		+			'<td>Bootstrap</td>'
		+			'<td></td>'
		+			'<td>Front-end component library for responsive, mobile-first projects on the web ... '
		+				'<a href="http://getbootstrap.com/" target="_blank" rel="noopener">more</a></td>'
		+			'<td><a href="https://github.com/twbs/bootstrap/blob/master/LICENSE" target="_blank" rel="noopener">MIT</a></td>'
		+		'</tr>'
		+ (moduleManager.isReady('diff')?
			...
			+			'<a href="https://code.google.com/p/google-diff-match-patch/" target="_blank" rel="noopener">more</a></td>'
			+		'<td><a href="http://www.apache.org/licenses/LICENSE-2.0" target="_blank" rel="noopener">Apache 2.0</a></td>'
			+	'</tr>'
			:   '')
		+	'</tbody>'
		+	'</table>'
