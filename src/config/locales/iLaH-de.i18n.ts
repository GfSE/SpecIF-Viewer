...
// Messages:
	...
	self.MsgImportSpecif = 'Zulässige Dateitypen sind *.specif, *.specif.zip and *.specifz. Inhalte müssen den Schemata für SpecIF 0.10.4+ entsprechen. Bei großen Dateien kann der Import einige Minuten dauern.';
